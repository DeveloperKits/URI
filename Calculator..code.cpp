...
int n,i;
double m,temp,result;
char work;

/* dada jokon ami void input function ta use kori...jei jaiga gulite input neya dorker ...tokon ei function ta kaj kortece na kno???
...
/* Dada ei function e problem ace but ki problem bujteci na....apni run koraiye bujte parben */
...
int main()
{
    ...
    while(true)
    {
        ...
        while(true)
        {
            ...
            cin>>m;
            result=ifelse2(work,result,m);//there have some problem...
        }
